...
cardes = [ Div(
                        Div(
                            Div('Wild', cls='header'),
                            Div('Elephant', cls='desc'),
                            cls='centered'
                        ),
                        Div(
                            I(cls='fa fa-quote-left'),
                            'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean pulvinar placerat pulvinar. Mauris consequat dui ut quam sollicitudin, vitae fermentum orci mattis. Morbi id justo ultricies, mollis leo sed, aliquet mi',
                            cls='details quote'
                        ),
                        style='height: 254px;',
                        cls='slider-item equal-height style-6'
                    ...
                    Div(
                        Div(
                            Img(src='https://images.unsplash.com/photo-1707397902790-4eb7e40b714d', alt='Elephant'),
                            cls='slider-image cell-left'
                        ),
                        Div(
                            Div('Wild', cls='header'),
                            Div('Elephant', cls='desc'),
                    ...
                    Div(
                        Div(
                            Img(src='https://images.unsplash.com/photo-1708245248056-b71d774931a2', alt='Rose'),
                            cls='slider-image cell-left'
                        ),
                        Div(
                            Div('Wild', cls='header'),
                    ...
                    Div(
                        Div(
                            Img(src='https://images.unsplash.com/photo-1711216798087-df556b37f358', alt='Rose'),
                            cls='slider-image cell-left'
                        ),
                        Div(
                            Div('Insect', cls='header'),
                            Div('Butterflies', cls='desc'),
                            cls='cell-right'
                        ),
                        Div(
                            I(cls='fa fa-quote-left'),
                    ...
                    Div(
                        Div(
                            Img(src='https://images.unsplash.com/photo-1710125246865-851d06ad7dbc', alt='Rose'),
                            cls='slider-image cell-left'
                        ),
                        Div(
                            Div('Wild', cls='header'),
                    ...
                    Div(
                        Div(
                            Img(src='https://images.unsplash.com/photo-1710715624029-f7fad59c925d', alt='Rose'),
                            cls='slider-image cell-left'
                        ),
                        Div(
                            Div('Wild', cls='header'),
                    ...
                    Div(
                        Div(
                            Img(src='https://images.unsplash.com/photo-1711110266240-584fa3a9f5f4', alt='Rose'),
                            cls='slider-image cell-left'
                        ),
                        Div(
                            Div('Wild', cls='header'),
                    ...
                    Div(
                        Div(
                            Img(src='https://images.unsplash.com/photo-1710580124362-113714e648ea', alt='Rose'),
                            cls='slider-image cell-left'
                        ),
                        Div(
                            Div('Wild', cls='header'),
...
gitUrl = "images/github-142-svgrepo-com.svg"
